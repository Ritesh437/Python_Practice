...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.line.setGeometry(QtCore.QRect(10, 140, 521, 16))
        ...
        self.line_2.setGeometry(QtCore.QRect(10, 370, 521, 16))
        ...
        self.labeld = QtWidgets.QLabel(self.group3)
        self.labeld.setGeometry(QtCore.QRect(10, 20, 121, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.show_btn.setGeometry(QtCore.QRect(60, 60, 110, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def show(self):
        ...
        text = font_22.render(f'Angular Error = {Deg}° {Min}\' {Sec}\"', True, Color_line)
        textRect = text.get_rect()
        textRect.center = (100, 50)
        ...
        text = font_22.render(f'ΣL = {ΣL}', True, Color_line)
        textRect = text.get_rect()
        textRect.center = (100, 50)
        ...
        text = font_22.render(f'ΣD = {ΣD}', True, Color_line)
        textRect = text.get_rect()
        textRect.center = (100, 50)
        ...
        text = font_22.render(f'Closing Error = {tot_err}', True, Color_line)
        textRect = text.get_rect()
        textRect.center = (100, 50)
        ...
        text = font_22.render(f'Relative Precision = 1 : {rel_pre}', True, Color_line)
        textRect = text.get_rect()
        textRect.center = (100, 50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labeld.setText(_translate("MainWindow", "Draw Traverse : "))
        self.show_btn.setText(_translate("MainWindow", "Draw"))
